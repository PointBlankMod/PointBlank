...
namespace PointBlank.API.Services
{
    ...
    public static class PointBlankServiceManager
    {
        ...
        /// </summary>
        public static string[] RunningServices => PBEnvironment.services.Where(a => a.Value.Enabled).Select(a => a.Key) as string[];

        /// <summary>
        /// Returns a list of the current stopped services
        /// </summary>
        public static string[] StoppedServices => PBEnvironment.services.Where(a => !a.Value.Enabled).Select(a => a.Key) as string[];

        /// <summary>
        /// Returns a list of all the current services
        /// </summary>
        public static string[] AllServices => PBEnvironment.services.Select(a => a.Key) as string[];
        #endregion
        ...
        public static bool StopService(string serviceName) => PBEnvironment.services[serviceName].Stop();
        ...
        public static bool StartService(string serviceName) => PBEnvironment.services[serviceName].Start();
        ...
        public static PointBlankService GetService(string serviceName) => PBEnvironment.services[serviceName].ServiceClass;
        #endregion
    }
}
